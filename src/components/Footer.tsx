import { Clock, Heart, Instagram, Linkedin, MapPin, Phone, Twitter } from "lucide-react"

const Footer = () => {
  const contactItems = [
    {
      icon: Phone,
      text: "+90 (539) 234 56 78",
    },
    {
      icon: MapPin,
      text: "Moda,Kadıköy",
    ...
    <footer className="bg-gray-900 text-white space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 place-items-start md:place-items-center">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold">Mehmet ARI</h3>
      ...
      <div className="border-t border-gray-800 p-8 text-center">
        <p className="text-gray-400">
          ©️ 2025 Mehmet ARI Veteriner Kliniği. Tüm hakları saklıdır.
        </p>
      </div>
    </footer>
  );
